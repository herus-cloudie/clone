  ...
  return (
    <div className="flex justify-center items-center flex-col gap-3 w-full h-screen">
      ...
      <div className="flex justify-around items-end gap-5">
        ...
        <Button onClick={() => setIsDialogOpen(true)} className="bg-dark-4 px-4 py-2.5 text-xl mt-5 rounded-md">دعوت<img alt="group icon" style={{ filter: 'invert(1)' }} className="mr-1" src='/icons/group.png' width={25} height={25} /></Button>
      </div>
